...
type Strategy struct {
	...
	//StrategyChain   []*Strategy       `json:"strategy_chain"` // 组合报警
	UnionStrategyId int `json:"union_strategy_id"` // 组合报警
	//StrategyChain *ScS `json:"sc"` // 组合报警
}
...
type OneStrategiesResponse struct {
	Strategies []*Strategy `json:"strategies"`
}
...
type UnionStrategiesResponse struct {
	UnionStrategiesMap map[int][]*Strategy `json:"union_strategies_map"`
}
