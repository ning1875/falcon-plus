...
import (
	...
	"github.com/open-falcon/falcon-plus/modules/apiproxy/app/controller"
	"github.com/open-falcon/falcon-plus/modules/apiproxy/config"
...
func main() {
	...
	log.Debugf("will start with port:%v,read_timeout:%+v,write_timeout:%+v", viper.GetString("web_port"), viper.GetInt("read_timeout"), viper.GetInt("write_timeout"))
